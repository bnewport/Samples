...
/**
 * This class is meant as a base class for loaders. It's main purpose is to provide a common table name and the getData
 * method.
 * 
 * @author bnewport
 * 
...
public abstract class BaseJDBCLoader {
	...
	/**
	 * This will create a JDBC Connection instance or return the current one associated with this WXS transaction.
	 * 
	 * @param tx
	 * @return A JDBC Connection that can be used for the specified tx
	 */
	static public Connection getConnection(TxID tx) throws SQLException {
		/*
	...
	public void copyPojoListToBatch(Connection conn, String sql, ArrayList<LogElement> list, ArrayList<Field> fields, ArrayList<String> fieldNames,
			ArrayList<Field> keyFields, ArrayList<String> keyFieldNames) throws SQLException, IllegalAccessException, NoSuchFieldException {
	...
	public <T> T copyResultSetToPojo(ResultSet rs, Class<T> c, ArrayList<Field> allFields) throws InstantiationException, IllegalAccessException,
			SQLException {
