...
public interface WXSMapOfLists<K, V> {
	...
	/**
	 * This pushes a list of value together on to the right side of a list.
	 * 
	 * @param key
	 * @param values
	 */
	 ...
	 *            The key for the list
	 * @param low
	 *            The 0-index for the left most element to return
	 * @param high
	...
	/**
	 * The length of the list for the key. 0 if the list doesn't exist
	 * 
	 * @param key
	 *            The key for the list
	 ...
	 *            The list to evict
	 * @param type
	 *            Last Creation time or last access time
	 * @param intervalSeconds
	 *            The time in seconds after which to evict
	 */
	@Beta
