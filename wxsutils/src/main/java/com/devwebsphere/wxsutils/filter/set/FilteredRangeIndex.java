...
/**
 * This is a class for applying a Filter layer on top of range indexes. This is designed for a local shard, not clients.
 * 
 * @author bnewport
 * 
 * @param <K>
...
public class FilteredRangeIndex<K extends Serializable, V extends Serializable> extends FilteredIndex<K, V> {
	...
	/**
	 * This returns entries whose attributes are between the specified low and high values.
	 * 
	 * @param low
	 * @param high
	 * @param f
	...
	/**
	 * This is an implementation method for implementing the relational methods
	 * 
	 * @param op
	 * @param a
	 * @param f
