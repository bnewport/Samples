 ...
 *
 */
public abstract class ValueLoader extends BasePQLoader implements Loader
{
	static Logger logger = Logger.getLogger(ValueLoader.class.getName());
	/**
...
//		data.endBatch();
	 ...
	 * then return Loader.KEY_NOT_FOUND
	 */
