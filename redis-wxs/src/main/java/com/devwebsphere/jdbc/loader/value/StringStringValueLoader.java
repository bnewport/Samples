...
public class StringStringValueLoader extends JDBCValueLoader<String,String> {
	static public class KV extends TemplateStringKeyProperty<String>
	{
		public String value;
		public KV() {};
	...
	@Override
	public BaseKeyValue<String,String> getPOJOProperty(LogElement e) 
	{
		return new KV(e);
	}
